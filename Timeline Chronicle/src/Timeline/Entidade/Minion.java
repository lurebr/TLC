 ...
 * @author Desenv01
 */
public class Minion extends GameObject implements isAttackable, isDrawable,
		isWalkable, isColide {
	...
	public void draw(Graphics g) {
		if (this.vivo) {
			...
			this.barraDeVida.draw(g, (int) super.localizacao.getX(),
					(int) super.localizacao.getY(), super.tamanho.getWidth(),
					super.tamanho.getHeight(), super.atributo.getVida());
		}
	}
