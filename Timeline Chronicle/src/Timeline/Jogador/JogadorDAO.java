...
public class JogadorDAO {
	...
	public void cadastrarJogador(Jogador j) throws SQLException {
		stm.execute("insert into jogador(nick,gold,level) values(" + "'"
				+ j.getNick() + "'," + j.getGold() + "," + j.getLevel() + ") ");
	}
	...
	public void atualizaJogador(Jogador j) throws SQLException {
		stm.execute("update jogador set nick = " + "'" + j.getNick() + "',"
				+ j.getGold() + "," + j.getLevel() + " where id = " + j.getId());
	}
